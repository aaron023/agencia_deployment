...
CREATE TABLE `testimoniales` (
  ...
  `nombre` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `correo` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `mensaje` text,
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf_general_ci;
...
INSERT INTO `testimoniales` VALUES (1,'Aaron','aaronacr@gmail.com','Unas excelentes vacaciones'),(2,'Yadira','yadira.riosdc@gmail.com','Las mejores vacaciones que he tenido'),(3,'Mario Olvera','mario@correo.com','La mejor atención y experiencia de usuario');
...
-- Dump completed on 2022-05-17 13:01:23
